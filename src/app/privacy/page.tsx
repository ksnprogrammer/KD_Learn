        ...
        <LegalLayout>
            <Card>
                ...
                <CardContent className="space-y-6 text-muted-foreground">
                    <h3 className="font-headline text-2xl text-card-foreground">1. Our Vow of Secrecy</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">2. Information We Gather</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">3. How We Use Your Information</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">4. Sharing Your Information</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">5. Securing the Realm</h3>
