        ...
        <LegalLayout>
            <Card>
                ...
                <CardContent className="space-y-6 text-muted-foreground">
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">2. Your Knighthood (Account)</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">3. Code of Conduct</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">4. The Kingdom's Treasures (Content)</h3>
                    ...
                    <h3 className="font-headline text-2xl text-card-foreground">5. Changes to the Pact</h3>
